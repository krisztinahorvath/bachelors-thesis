...
const handleSubmit = async (event: { preventDefault: () => void; }) => {
    ...
    formData.append('courseDTO', JSON.stringify({ name: course.name, enrollmentKey: course.enrollmentKey }));
    if (course.image) {
  ...
  const handleCreateCourse = async (event: {preventDefault: () => void }) => {
    ...
    try {
        ...
        const response = await axios.post(`${BACKEND_URL}/courses/create`, course, headers);
    ...
    <React.Fragment>
        ...
        >
            ...
            <form onSubmit={handleSubmit} style={formStyle}>
                ...
                />
                <Container/>
                <p> <b>Note:</b> When the course is created an enrollment key will be automatically generated for it, 
                    to see it or change it in the course's page.</p>
                <Button
                    type="submit"
